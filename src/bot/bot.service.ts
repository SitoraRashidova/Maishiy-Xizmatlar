...
export class BotService {
  ...
  async onStart(ctx: Context) {
    await ctx.reply("Click the regiter button", {
      parse_mode: "HTML",
  ...
  async onHeartAuth(ctx: Context) {
    await ctx.reply("Who do you like register as?", {
      parse_mode: "HTML",
  ...
  async onHearsMaster(ctx: Context) {
    ...
    await ctx.reply("Show your speciality", {
      parse_mode: "HTML",
      reply_markup: {
  ...
  async onHearsClient(ctx: Context) {
    ...
    await ctx.reply("Enter your fullname:", {
      parse_mode: "HTML",
  ...
  async onClickJob(ctx: Context) {
    ...
    if (!user) {
      ...
      await ctx.reply(`A master can choose only one job`, {
        parse_mode: "HTML",
        ...Markup.removeKeyboard(),
      });
    }
  ...
  async onText(ctx: Context) {
    if ("text" in ctx.message) {
      ...
      const user = await this.botModel.findByPk(userId);
      if (!user) {
        await ctx.reply(`You are not regitered yet`, {
          parse_mode: "HTML",
        ...
        if (master && master.last_state !== "finish") {
          if (master.last_state == "master_name") {
            ...
            await master.save();
            await ctx.reply(`Send your contact number:`, {
              parse_mode: "HTML",
              ...Markup.keyboard([
                Markup.button.contactRequest("📞 Send your contact number"),
              ])
                .oneTime()
                .resize(),
            });
            ...
            master.save();
            await ctx.reply("Enter workshop address:", {
              parse_mode: "HTML",
              ...Markup.removeKeyboard(),
            });
            ...
            master.save();
            await ctx.reply("Enter working finish time:", {
              parse_mode: "HTML",
              ...Markup.removeKeyboard(),
            });
            ...
            master.save();
            await ctx.reply("How much time takes for a client on average?", {
              parse_mode: "HTML",
              ...Markup.removeKeyboard(),
            });
